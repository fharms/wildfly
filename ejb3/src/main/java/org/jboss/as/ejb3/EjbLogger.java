...
public interface EjbLogger extends BasicLogger {
    ...
    void asyncInvoationFailed(@Cause Throwable cause);
    ...
    void unknowTimezoneId(String timezoneId, String id);
    ...
    void failToRetoreTimers(File file);
    ...
    void failToRetoreTimersFromFile(File timerFile, @Cause Throwable e);
