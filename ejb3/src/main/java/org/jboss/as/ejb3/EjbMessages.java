...
public interface EjbMessages {
    ...
    IllegalArgumentException noNamepaceContextSelectorAvailable(String name);
     ...
     *
     * @param ejbObject type of object
     *
     * @return a {@link IllegalStateException} for the error.
     */
    @Message(id = 14377, value = "Cannot call getInvokedBusinessInterface when invoking through %s")
    IllegalStateException failTogetInvokedBusinessInterface(String ejbObject);
    ...
    UnsupportedOperationException resourceBuldeDescriptionsNotSupported(String name);
